...
type BookingRequest struct {
	...
	TravelClass   string                 `protobuf:"bytes,4,opt,name=travelClass,proto3" json:"travelClass,omitempty"`
	...
	Pnr           string                 `protobuf:"bytes,8,opt,name=pnr,proto3" json:"pnr,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *BookingRequest) GetTravelClass() string {
	if x != nil {
...
func (x *BookingRequest) GetPnr() string {
	if x != nil {
		return x.Pnr
	}
	return ""
...
const file_proto_booking_proto_rawDesc = "" +
	"\n" +
	"\x13proto/booking.proto\x12\x0eticket_backend\"@\n" +
	"\n" +
	"SeatConfig\x12\x1c\n" +
	...
	"\x03age\x18\x03 \x01(\x05R\x03age\"\x97\x02\n" +
	...
	"\vtravelClass\x18\x04 \x01(\tR\vtravelClass\x12\x14\n" +
